          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-4">
              <label class="flex items-center space-x-2">
                <input v-model="localUser.is_staff" type="checkbox" />
                <span>Is Staff</span>
              </label>

              <label class="flex items-center space-x-2">
                <input v-model="localUser.is_active" type="checkbox" />
                <span>Is Active</span>
              </label>

              <label class="flex items-center space-x-2">
                <input v-model="localUser.is_superuser" type="checkbox" />
                <span>Is Superuser</span>
              </label>

              <label class="flex items-center space-x-2">
                <input v-model="localUser.is_verify" type="checkbox" />
