<template>
  ...
  <script setup lang="ts">
    ...
    const { getAll, state, setStateFilter } = footerStore();

    const editItem = (id: string) => {
        push({ name: 'edit.footer', params: { id: id} });
    }
    ...
    async function onPageChange(event: DataTablePageEvent) {
        ...
        push({ name: 'footer', query: { page, limit, search: filter?.email ? filter.email : undefined } })
