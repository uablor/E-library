<template>
  <div v-if="props.show" class="fixed inset-0 z-50 bg-opacity-70 flex items-center justify-center"
    ...
    <div class="bg-white rounded-lg shadow-md w-full max-w-lg p-6 relative border-b border-gray-400">
      ...
      <button class="absolute top-2 right-2 text-gray-600 hover:text-red-500 cursor-pointer" @click="$emit('close')">✕</button>
