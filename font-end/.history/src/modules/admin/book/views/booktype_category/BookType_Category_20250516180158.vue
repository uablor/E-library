   ...
   <div class="flex gap-5 mx-auto container ">
    ...
    <!-- end table -->
      <div class="w-150 mt-20 border">
        <div  class="ml-88">
          <select v-model="toggleForm" class="bg-green-600 text-white px-2 py-1 h-9 focus:outline-none cursor-pointer rounded-l">
...
const function toggleForm(state: boolean) {
