    ...
    <!-- end table -->
      <div class="w-150 mt-20 ">
        <div  class="ml-88">
         ...
         <option value="all" class="cursor-pointer">Select Book Type or Category</option>
          <option value="false" class="cursor-pointer">Book Type</option>
          <option value="true" class="cursor-pointer">Book Category</option>
        </select>
        </div>
        <div v-if="change_From_caogrory_to_type == false" class="">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4 bg-white p-4 rounded shadow">
            <div>
              ...
              <input v-model="form.name" type="text" class="w-full border border-gray-300 p-2 rounded outline-green-300 " required />
            </div>
