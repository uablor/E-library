...
/*************  ✨ Windsurf Command ⭐  *************/
    <div class="mt-12">
      <h2 class="text-2xl font-bold mb-4">📝 Book Type Data</h2>
      <form class="space-y-4">
        <div>
          <label class="block font-medium mb-1">Name</label>
          <input v-model="form.name" type="text" class="w-full border p-2 rounded" readonly />
        </div>

        <div>
          <label class="block font-medium mb-1">Description</label>
          <textarea v-model="form.description" class="w-full border p-2 rounded" readonly></textarea>
        </div>

        <div>
          <label class="block font-medium mb-1">Created At</label>
          <input type="text" :value="form.created_at ? form.created_at.toLocaleString() : ''" class="w-full border p-2 rounded" readonly />
        </div>

        <div>
          <label class="block font-medium mb-1">Updated At</label>
          <input type="text" :value="form.updated_at ? form.updated_at.toLocaleString() : ''" class="w-full border p-2 rounded" readonly />
        </div>
      </form>
    </div>
/*******  346da6a1-6d72-4e08-abdd-3db2cbccfe84  *******/
  </div>
</template>
