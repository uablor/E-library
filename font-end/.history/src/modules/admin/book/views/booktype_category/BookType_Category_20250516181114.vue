        ...
        <div v-if="change_From_caogrory_to_type == false" class="">
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4 bg-white p-4 rounded shadow">
            <div>
              ...
              <input v-model="form.name" type="text" class="w-full border border-gray-300 p-2 rounded" required />
            </div>
      
            <div>
              <label class="block font-medium mb-1">Description</label>
              <textarea v-model="form.description" class="w-full border border-gray-300 border outline-green-600 p-2 rounded" required></textarea>
            </div>
