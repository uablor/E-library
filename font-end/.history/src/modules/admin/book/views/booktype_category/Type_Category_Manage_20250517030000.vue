...
<template>
  ...
  <div v-if="change_From_caogrory_to_type == false">
    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-500">📘 Book Type</h2>
  ...
  <div v-else class="space-y-6">
    <h2 class="text-xl md:text-2xl font-bold mb-4 text-gray-500">📂 Book Category Management</h2>
