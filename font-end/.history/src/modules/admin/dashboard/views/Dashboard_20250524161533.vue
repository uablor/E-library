...
const chartIds: string[] = [' ລາຍງານຜູ້ໃຊ້', ' ລາຍງານນັກສຶກສາ', 'ລາຍງານປື້ມເອກະສານ', 'ຄະແນນ & ຄວາມຄິດເຫັ', 'ລາຍງານສິດ']
        ...
        datasets: [
          {
            ...
            data: [
              ...
              Math.floor(Math.random() * 100), // Last month
              Math.floor(Math.random() * 100), // 2 months ago
              Math.floor(Math.random() * 300), // Summary (can be sum of above or separate)
            ],
            backgroundColor: [
              'rgba(75, 192, 192, 0.5)',
              'rgba(255, 206, 86, 0.5)',
