      ...
      <form @submit.prevent="handleSave">
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="localUser.code_student" class="input" />
          </div>
          <div>
          ...
          <div>
            ...
            <input v-model="localUser.email" class="input" />
          </div>
          <div>
            <label class="block text-sm font-medium">ຊື່ແທ້</label>
            <input v-model="localUser.firstname" class="input" />
          </div>
          <div>
            <label class="block text-sm font-medium">ວັນເກີດ</label>
            <input type="date" v-model="localUser.birthday" class="input" />
          </div>
          <div>
            <label class="block text-sm font-medium">ທີ່ຢູ່</label>
            <input v-model="localUser.address" class="input" />
          </div>
          <div>
            <label class="block text-sm font-medium">ພະແນກ</label>
            <input v-model="localUser.department" class="input" />
          </div>
          <div>
...
<style scoped>
.input {
  @apply mt-1 block w-full rounded border border-gray-300 px-3 py-2 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500;
}
</style>
