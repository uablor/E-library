          ...
          <tbody v-if="isSoftDeleteOpen">
            <tr v-for="user in filteredUsers" :key="user.id" @click="selectUser(user)"
              ...
              <td class="py-2 px-4 whitespace-nowrap">{{ user.email }}</td>
               <td class="py-2 px-4 whitespace-nowrap tex"><i :class="user.is_staff ? 'fa-solid fa-check text-green-600' : 'fa-solid fa-circle-exclamation text-yellow-600'"></i></td>
              <td class="py-2 px-4 whitespace-nowrap tex"><i :class="user.is_active ? 'fa-solid fa-check text-green-600' : 'fa-solid fa-circle-exclamation text-yellow-600'"></i></td>
              <td class="py-2 px-4 whitespace-nowrap tex"><i :class="user.is_superuser ? 'fa-solid fa-check text-green-600' : 'fa-solid fa-circle-exclamation text-yellow-600'"></i></td>
              <td class="py-2 px-4 whitespace-nowrap tex"><i :class="user.is_verify ? 'fa-solid fa-check text-green-600' : 'fa-solid fa-circle-exclamation text-yellow-600'"></i></td>
