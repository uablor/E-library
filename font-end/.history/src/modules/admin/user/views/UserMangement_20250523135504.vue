<template>
  ...
  :disabled="!selectedUser || inbtnEdit_Delete"
  :class="{ 'opacity-50 cursor-not-allowed': !selectedUser || inbtnEdit_Delete }">ເເກ້ໄຂ</button>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg text-sm md:text-base">
          ...
          <tbody>
            <tr v-for="user in filteredUsers" :key="user.id" @click="selectUser(user)" :class="[
  ...
  <!-- Modal addUser -->
  <AddUserModal :show="isModalOpen"  :boolenstatus="inbtnEdit_Delete" :user="selectedUser" @close="isModalOpen = false" @save="saveUser"  @changeBoolenstatus="inbtnEdit_Delete = $event"/>

  <!-- Edit Modal -->
  <EditUserModal
  :show="isEditModalOpen"
   :userData="selectedUser !== null ? selectedUser : {}"
  :boolenstatus="inbtnEdit_Delete"
  @close="isEditModalOpen = false"
  @changeBoolenstatus="inbtnEdit_Delete = $event"
