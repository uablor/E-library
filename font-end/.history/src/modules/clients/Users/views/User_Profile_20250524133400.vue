<template>
  <div class="mx-auto px-4 p-4 max-w-4xl">
    ...
    <div class="relative w-40 h-40">
      <!-- Gradient Ring -->
      <div class="absolute inset-0 rounded-full border-4 border-gradient-to-tr from-green-400 via-blue-500 to-purple-600"></div>
      <!-- Profile Image -->
      <img
       src="../../../../assets/images/profile-one.webp"
        alt="User Avatar"
