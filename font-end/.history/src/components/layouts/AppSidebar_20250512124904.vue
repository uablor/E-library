                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    ...
                    <div class="relative inline-block mt-10">
                      ...
                      <transition name="slide-down">
                        <div v-if="isOpen" class="absolute left-0 -mt-3  w-48 ml-10   z-10">
                          <ul class="py-2 text-white">
                            <li>
                              <a href="#"
                                class="block px-4 py-2 text-sm hover:bg-green-700 underline focus:outline-none bg-white text-black">Book</a>
                            </li> 
                            <li>
                              <a href="#"
