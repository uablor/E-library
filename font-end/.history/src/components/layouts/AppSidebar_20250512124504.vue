                      ...
                      <transition name="slide-down">
                        <div v-if="isOpen" class="absolute left-0  w-48 ml-7 shadow-lg bg-green-600 z-10">
                          <ul class="py-2 text-white">
                            <li>
                              <a href="#"
                                class="block px-4 py-2 text-sm hover:bg-green-700 focus:outline-none bg-white text-">Book</a>
                            </li> 
                            <li>
                              <a href="#"
                                class="block px-4 py-2 text-sm hover:bg-green-700 focus:outline-none bg-white text-">Book
                                type</a>
                            </li>
                            <li>
                              <a href="#"
                                class="block px-4 py-2 text-sm hover:bg-green-700 focus:outline-none bg-white text-">Categories</a>
                            </li>
