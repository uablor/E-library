                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    ...
                    <div class="relative inline-block mt-10">
                        ...
                        class=" text-black font-semibold py-2 px-4  focus:outline-none flex focus:shadow-outline " style="font-size: 20px; font-weight: bold; color:darkslategray;">
                         <i v-if="!isOpen" class="fa-solid fa-angle-right mt-5"></i>
                        <i v-if="isOpen" class="fa-solid fa-angle-down mt-2 m"></i>
                       <div class="border-b">
                        Books manage
                       </div> 
                      </button>
