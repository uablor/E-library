                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    ...
                    <div class="flex gap-10 items-center justify-center">
                      ...
                      <button
                        class="pl-13 pr-13 pt-3 pb-3 bg-green-600 border-2 text-white border-green-600 transition cursor-pointer hover:bg-white hover:text-green-600 gap-1"><span>Log</span> <span>in</span></button>
                    </div>
                    <!-- drop down menus -->
